...
let basicSalary = parseFloat(promt("Enter your monthly Basic Salary:"));
let benefits = parseFloat(promt("Enter your monthly total Benefits:"));

//calculating gross salary
let grossSalary = basicSalaryn + benefits;
//functions for calculating payee
function calcutePayee(grossSalary){
...
let payee = calcutePayee(grossSalary);
...
console.log("NHIF Deuction:" + nhif + "Ksh");

//function for calculating nssf deduction
function nssfDeduction(grossSalary){
    if (grossSalary<= 6000){//6% deduction gross salary
